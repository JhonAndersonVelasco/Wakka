...
class CachePage(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._clean_pacman_btn = clean_pacman_btn
        ...
        self._clean_uninst_btn = clean_uninst_btn
        ...
        self._clean_aur_btn = clean_aur_btn
        ...
        self._clean_orphan_btn = clean_orphan_btn
    ...
    def set_privileged_operation_running(self, running: bool):
        ...
        self._clean_pacman_btn.setEnabled(not running)
        self._clean_uninst_btn.setEnabled(not running)
        self._clean_aur_btn.setEnabled(not running)
        self._clean_orphan_btn.setEnabled(not running)
